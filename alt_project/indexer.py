...
def new_index(doc_dir, index_dir):
    ...
    dicts=[doc_dir, art_index, inv_index, title_index, summary_index, keywords_index, date_index, stem_index, perm_rotations, perm_rotations_keywords, perm_rotations_date, perm_rotations_title, perm_rotations_sum, n_arts]
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        print('USAGE: SAR_indexer <documents_directory> <index_directory>')
    else:
